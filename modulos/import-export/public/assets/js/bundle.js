...
var nome = 'Jonas';
var sobrenome = 'Humberto';
var idade = 22;
function soma(x, y) {
  return x + y;
}
var Car = /*#__PURE__*/_createClass(function Car(nome, preco) {
...
console.log("O ".concat(_modulo1__WEBPACK_IMPORTED_MODULE_0__.nome, " ").concat(_modulo1__WEBPACK_IMPORTED_MODULE_0__.sobrenome, ", tem ").concat(_modulo1__WEBPACK_IMPORTED_MODULE_0__.idade, " anos"));

var resultado = (0,_modulo1__WEBPACK_IMPORTED_MODULE_0__.soma)(2, 5);
console.log(resultado);

var carro = new _modulo1__WEBPACK_IMPORTED_MODULE_0__.Car('Fusca', 15000);
console.log(carro);

// Pegando o valor padrão do arquivo modulo1.

console.log((0,_modulo1__WEBPACK_IMPORTED_MODULE_0__["default"])(7, 2));
